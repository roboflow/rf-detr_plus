...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(RFDETRXLarge, 0.77, 0.74, 300, marks=pytest.mark.gpu, id="xlarge-GPU"),
        pytest.param(RFDETR2XLarge, 0.78, 0.74, 300, marks=pytest.mark.gpu, id="2xlarge-GPU"),
    ],
)
